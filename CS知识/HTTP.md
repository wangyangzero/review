...
万维网中超文本是一个很重要的概念，蒂姆从1960年代的几个项目中获取灵感，并向项目技术的使用者建议结合这些技术，但却没有获得相应。所以蒂姆只好自己解决了这个计划，他发明了一个全球网络资源唯一认证的系统：统一资源标识符。
...
- **f-None-Match**： 再次请求服务器时，浏览器的请求报文头部会包含此字段，后面的值为在缓存中获取的标识
